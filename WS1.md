# Hướng dẫn Thiết lập Web Server (192.168.168.10)
...
Để phân biệt với máy Backup, ta đổi tất cả dòng chữ "Web server Primary" thành "Web server 1" trong toàn bộ mã nguồn:

```bash
cd /var/www/html

# Đổi tên hiển thị cho webserver 1 và trong tất cả các tệp PHP (bao gồm admin.php, dashboard.php,...)
sudo find . -type f -name "*.php" -exec sed -i 's/Web server Primary/Web server 1/g' {} +
