DB:
# Cập nhật và cài đặt MariaDB cùng công cụ tải file
sudo apt update && sudo apt install mariadb-server wget -y

# Bảo mật MySQL (Lưu ý: Đặt mật khẩu root và chọn Y cho các câu hỏi)
...
# Mở tường lửa cho cả 2 IP
___________________________
# Cho phép máy Primary (.10)
sudo ufw allow from 192.168.168.10 to any port 3306

# Cho phép máy Backup (.20) - Bạn đã làm rồi nhưng chạy lại cho chắc
