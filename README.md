# 🛡️ Build-a-Web-Server: Multi-Layer Defense System
...
## 🛡️ Các Kịch Bản Phòng Thủ (Defense Scenarios)
...
### **KB 4: Lớp Dự phòng & Phục hồi (Data Resilience)**
* **Công cụ:** `Borg Backup`, `rsync`, `cron`.
* **Nhiệm vụ:** Hồi sinh dữ liệu khi tất cả các lớp trên đã thất thủ.
* **Kịch bản:** Chống Ransomware và xóa sạch dữ liệu (Data Destruction).
* **Bảo mật:** Bản sao lưu mã hóa bằng **Passphrase**. Hacker không thể giải mã nếu không có Private Key.

---

## 🤖 Giám sát & Cảnh báo (Monitoring)

Hệ thống tích hợp **Monitoring Script** (Bash/Python):
...
* **Cảnh báo Telegram:** Gửi thông báo tức thời tới quản trị viên khi:
    ...
    * Tiến trình sao lưu dữ liệu hoàn tất/thất bại.

---

## 🚀 Hướng dẫn Triển khai Nhanh

### 1. Cấu hình Firewall (VM1)
```bash
